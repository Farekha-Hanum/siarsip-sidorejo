...
const categories = [
  {
    ...
    logo: "/logo-ipnu.png",
    color: "#2d8c5a",
    link: "/admin/surat-digital/ipnu/buat"
  },
  {
    id: "ippnu",
    name: "IPPNU",
    ...
    logo: "/logo-ippnu.png",
    color: "#145c38",
    link: "/admin/surat-digital/ippnu/buat"
  },
  {
    id: "gabungan",
    name: "Gabungan",
    ...
    logo: "/logo-baru.png",
    color: "#0d3320",
    link: "/admin/surat-digital/gabungan/buat"
  }
];

export default function SuratSelectorPage() {
  return (
        ...
        {categories.map((cat, i) => (
          ...
          >
            ...
            <Link href={cat.link} className="w-full mt-8">
              <button 
                className="w-full py-4 rounded-2xl font-bold text-sm text-white flex items-center justify-center gap-2 transition-all shadow-lg active:scale-95"
      ...
      <div className="p-8 rounded-3xl bg-[#0d3320] text-white overflow-hidden relative">
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <Link href="/admin/scanner">
            <button className="px-8 py-3 rounded-xl bg-white/10 hover:bg-white/20 transition-all font-bold text-sm border border-white/10">
              Buka Scanner OCR
            </button>
          </Link>
        </div>
